      ...
      <div className="max-w-[1440px] mx-auto px-7 lg:px-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-[60px] py-[60px] border-b border-[#f3eee3]/10">
          <div>
            ...
            <p className="font-mono text-[13px] text-[#f3eee3]/50 leading-[1.6] text-justify ">
            ...
            >
              <input
                ...
                placeholder={intl.formatMessage({
                  id: "home.footer.sub.input.placeholder",
                })}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-8 py-12 border-b border-[#f3eee3]/10">
          ...
          <div className="col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              >
                {CELLS.map((on, i) => (
                  <span
                    key={i}
                    className={on ? "bg-[#f3eee3] block" : "block"}
                  />
                ))}
              </span>
            ...
            <p className="font-mono text-[12px] text-[#f3eee3]/50 leading-[1.6] md:max-w-[260px] text-justify ">
          ...
          <div>
            ...
            <Link
              href="/"
              className="block text-[13px] text-[#f3eee3]/70 hover:text-brand-accent transition-colors duration-150 mb-2"
            >
