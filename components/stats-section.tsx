...
const STATS = [
  ...
  { numId: 'home.stats.accuracy.num', lblId: 'home.stats.accuracy.lbl', accent: true  },
  { numId: 'home.stats.tools.num',    lblId: 'home.stats.tools.lbl',    accent: false },
  { numId: 'home.stats.founders.num', lblId: 'home.stats.founders.lbl', accent: false },
] as const
            ...
            <div className="font-serif text-[clamp(40px,5vw,64px)] leading-none tracking-[-0.03em] mb-2 text-brand-ink">
              {stat.accent ? (
                <span
                  ...
                  style={{ background: 'color-mix(in oklab, var(--brand-accent) 30%, transparent)' }}
                >
