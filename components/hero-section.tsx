...
export function HeroSection({ reportCount }: HeroSectionProps) {
  ...
  return (
    <section className="max-w-[1440px] mx-auto px-7 lg:px-14 py-[60px] pb-20">
      <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 items-center">
        ...
        <div>
          ...
          {/* H1 */}
          <h1 className="font-serif font-normal text-[clamp(48px,6.2vw,88px)] leading-[1.04] tracking-[-0.02em] mb-8 text-balance text-brand-ink">
            {mounted ? (
              <>
          ...
          {/* Lede */}
          <p className="text-[17px] leading-[1.55] text-brand-ink2 max-w-[540px] mb-8 text-pretty pr-4">
          ...
          <div className="flex gap-3 flex-wrap items-center mb-8">
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-[18px] py-3 rounded-full font-mono text-[13px] font-medium bg-brand-ink text-brand-bg border border-brand-ink hover:-translate-y-px transition-transform duration-150 group"
            >
              <FormattedMessage id="home.hero.cta.primary" />
              <span className="group-hover:translate-x-[3px] transition-transform duration-200">
                →
              </span>
            </Link>
            <Link
              href="/#feed"
              className="inline-flex items-center gap-2 px-[18px] py-3 rounded-full font-mono text-[13px] font-medium border border-brand-line-soft text-brand-ink hover:border-brand-ink transition-colors duration-150"
            >
        ...
        <div className="justify-self-center lg:justify-self-end relative hidden lg:block">
          ...
          >
            {/* Corner marks */}
            <span className="absolute top-[-1px] left-[-1px] w-3.5 h-3.5 border-t border-l border-brand-ink" />
            <span className="absolute top-[-1px] right-[-1px] w-3.5 h-3.5 border-t border-r border-brand-ink" />
            <span className="absolute bottom-[-1px] left-[-1px] w-3.5 h-3.5 border-b border-l border-brand-ink" />
            <span className="absolute bottom-[-1px] right-[-1px] w-3.5 h-3.5 border-b border-r border-brand-ink" />

            {/* Top stamp */}
            <div className="absolute -top-[10px] left-6 flex items-center gap-1.5 font-mono text-[10.5px] text-brand-ink bg-brand-paper px-2 py-[5px] border border-brand-line-soft whitespace-nowrap">
            ...
            {/* Bottom stamp */}
            <div className="absolute -bottom-[10px] right-6 font-mono text-[10.5px] text-brand-ink bg-brand-paper px-2 py-[5px] border border-brand-line-soft whitespace-nowrap">
